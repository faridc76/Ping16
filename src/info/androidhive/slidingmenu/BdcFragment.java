...
private FragmentTabHost mTabHost;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTabHost.addTab(mTabHost.newTabSpec("fragmenta").setIndicator("Créer un bon de commande"),
                BdcFragment1.class, null);
        mTabHost.addTab(mTabHost.newTabSpec("fragmentb").setIndicator("Demande de personnel"),
        		BdcFragment2.class, null);
