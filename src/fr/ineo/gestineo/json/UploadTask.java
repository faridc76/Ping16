...
/**
 * Classe permettant d'upload un fichier dans une affaire gr�ce �
 * upload_fichier.php. Il faut fournir en param�tre le contexte et le
 * ProgressDialog qui permettra de montrer l'avancement de l'upload.
 * 
 * @author Ping16
 *
 */
public class UploadTask extends AsyncTask<String, Integer, String> {
	...
	protected void onProgressUpdate(Integer... progress) {
		...
		// Au cours de l'upload, on modifie l'�tat de la barre d'avancement
	...
	protected void onPostExecute(String result) {
		// On d�lock l'application
		mWakeLock.release();
		progressDialog.dismiss();
		if (result.equals("true"))
			Toast.makeText(context, "Upload termin�", Toast.LENGTH_LONG).show();
		else
	...
	protected String doInBackground(String... sUrl) {
		...
		String result = "";
		// On va choisir le fichier dont le path correspond � celui de l'affaire
		// et du fichier choisi
		File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/GestIneo/" + affaireName,
				fileName);
