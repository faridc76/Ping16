...
/**
 * Classe permettant de t�l�charger un fichier d'une affaire. Il faut fournir en
 * param�tre le contexte et le ProgressDialog qui permettra de montrer
 * l'avancement du t�l�chargement.
 * 
 * @author Ping16
 *
 */
