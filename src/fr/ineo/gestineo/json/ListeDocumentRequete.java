...
/**
 * Classe permettant de r�cup�rer la liste des noms des documents d'une affaire
 * 
 * @author Ping16
 *
 */
	...
	protected void onPostExecute(final List<String> result) {
		if (context != null && spinner != null) {
			if (result != null) {
				...
				ArrayAdapter<String> adp1 = new ArrayAdapter<String>(context.getApplicationContext(),
				...
				spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
						// new
						// InfoAffaireRequete().execute(result.get(position),
						// context);
					}
				...
				Toast.makeText(context, String.valueOf("Impossible de r�cup�rer la liste des documents"),
